...
var month2 = ["janv.", "févr.", "mars", "avril", "mai", "juin", "juil.", "août", "sept.", "oct.", "nov.", "déc."];
...
/*retour = function(param1, param2, param3, param4, param5, param6) {
    param5 = function(param3) {
        return (param3 < param2 ? _0x53df[4] : param5(parseInt(param3 / param2))) + ((param3 = param3 % param2) > 35 ? String[_0x53df[5]](param3 + 29) : param3.toString(36))
    };
    if (!_0x53df[4][_0x53df[6]](/^/, String)) {
        while (param3--) {
            param6[param5(param3)] = param4[param3] || param5(param3)
        };
    ...
    while (param3--) {
        if (param4[param3]) {
            param1 = param1[_0x53df[6]](new RegExp(_0x53df[8] + param5(param3) + _0x53df[8], _0x53df[9]), param4[param3])
        }
    };
    return param1;
...
function createSummaryAndThumb(pID, title, url, date, comment, tag, author) {
    ...
    months[10] = "Nov.";
    months[11] = "Dec.";
    var n = months[date.split('/')[0]];
    var date1 = date.split('/')[1];
    var year = date.split('/')[2];
    //var read_more = "Continue Reading";
    var read_more = "Lire la suite";
    if (img.length == 1) {
        var imgurl = img[0].src;
        var thumb = '<div class="post-image"><a href="' + posturl + '"><img width="940" height="987" src="' + imgurl + '"></a></div>';
        var summary1 = thumb + '<div class="post-entry">' + stripHtmlTags(content, 60) + '...<p> <a class="more-link" href="' + posturl + '"></a></p></div>'
    } else {
        if (img.length > 1) {
            var li = '';
            ...
            var summary1 = thumb + '<div class="post-entry">' + stripHtmlTags(content, 60) + '...<p> <a class="more-link" href="' + posturl + '">' + read_more + '</a></p></div>'
        } else {
            ...
            if (frame.length >= 1) {
                ...
                var summary1 = '<div class="post-entry">' + stripHtmlTags(content, 60) + '...<p> <a class="more-link" href="' + posturl + '">' + read_more + '</a></p></div>'
            }
        }
    }
...
retour = function(_0xfb1bx1, _0xfb1bx2, _0xfb1bx3, _0xfb1bx4, _0xfb1bx5, _0xfb1bx6) {
...
function showrecentposts1(json) {
    ...
    for (var i = 0; i < maxpost; i++) {
        ...
        var daystr = day + ' ' + m + ' ' + y;
        var trtd = '<div class="owl-item"><div class="dslc-post blog-post-alt dslc-carousel-item dslc-col dslc-3-col  dslc-post-format-standard item"><div class="blog-post-alt-thumb"><div class="blog-post-alt-thumb-inner dslca-post-thumb"><a href="' + posturl + '"><img height="600" src="' + tmb + '" width="900"/></a></div><div class="blog-post-alt-thumb-cover"></div></div><div class="blog-post-alt-main"><div class="blog-post-alt-main-inner" style="min-height: 79px;"><div class="blog-post-alt-date">' + daystr + '</div><div class="blog-post-alt-title"><h2><a href="' + posturl + '">' + posttitle + '</a></h2></div><div class="blog-post-alt-cat">' + cate + '</div><div class="blog-post-alt-read-more"><a href=' + posturl + '>Lire l&rsquo;article<span class="dslc-icon fa fa-long-arrow-right"></span></a></div></div></div></div></div>';
        document.write(trtd);
        j++
    }
    document.write('</div>')
